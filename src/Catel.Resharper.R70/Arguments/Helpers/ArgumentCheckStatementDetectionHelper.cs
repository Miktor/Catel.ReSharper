...
namespace Catel.ReSharper.Arguments.Helpers
{
    ...
    internal static class ArgumentCheckStatementDetectionHelper
    {
        ...
        /// </param>
        /// <returns>
        /// <c>true</c> if the is not match invoked, otherwise <c>false</c>.
        /// </returns>
        /// <exception cref="System.ArgumentException">
        /// The <paramref name="argumentName"/> is <c>null</c> or whitespace.
        /// </exception>
        ...
        /// </param>
        /// <returns>
        /// <c>true</c> if the is match invoked, otherwise <c>false</c>.
        /// </returns>
        /// <exception cref="System.ArgumentException">
        /// The <paramref name="argumentName"/> is <c>null</c> or whitespace.
        /// </exception>
